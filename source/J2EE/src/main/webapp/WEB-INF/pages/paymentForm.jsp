                ...
                <form:form id="paymentRegisterForm" cssClass="form-horizontal" modelAttribute="payment" method="post" action="savePayment">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            ...
                            <form:input cssClass="form-control" path="name" value="${paymentObject.name}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <form:input cssClass="form-control" path="age" value="${paymentObject.age}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <form:input cssClass="form-control" path="salary" value="${paymentObject.salary}"/>
                        </div>
                    </div>
